...
pub(crate) fn get_registry() -> (Vec<Rc<Item>>, HashMap<&'static str, Vec<Recipe>>) {
    ...
    let mut recipe_registry: HashMap<&'static str, Vec<Recipe>> = HashMap::new();
    {
        ...
        let iron_plate = Rc::new(Item {
            name: "Iron Plate",
            raw: false,
        }); // FactoryGame/Content/FactoryGame/Resource/Parts/IronPlate/Desc_IronPlate
        item_registry.push(iron_plate.clone());
        let rubber = Rc::new(Item {
            name: "Rubber",
            raw: false,
        }); // FactoryGame/Content/FactoryGame/Resource/Parts/Rubber/Desc_Rubber
        ...
        let screw = Rc::new(Item {
            name: "Screw",
            raw: false,
        }); // FactoryGame/Content/FactoryGame/Resource/Parts/IronScrew/Desc_IronScrew
        item_registry.push(screw.clone());
        let cable = Rc::new(Item {
            name: "Cable",
            raw: false,
        }); // FactoryGame/Content/FactoryGame/Resource/Parts/Cable/Desc_Cable
        item_registry.push(cable.clone());
        let wire = Rc::new(Item {
            name: "Wire",
            raw: false,
        }); // FactoryGame/Content/FactoryGame/Resource/Parts/Wire/Desc_Wire
        ...
        let iron_ingot = Rc::new(Item {
            name: "Iron Ingot",
            raw: false,
        }); // FactoryGame/Content/FactoryGame/Resource/Parts/IronIngot/Desc_IronIngot
        item_registry.push(iron_ingot.clone());
        let plastic = Rc::new(Item {
            name: "Plastic",
            raw: false,
        }); // FactoryGame/Content/FactoryGame/Resource/Parts/Plastic/Desc_Plastic
        ...
        let iron_ore = Rc::new(Item {
            name: "Iron Ore",
            raw: true,
        }); // FactoryGame/Content/FactoryGame/Resource/RawResources/OreIron/Desc_OreIron
        ...
        let copper_ore = Rc::new(Item {
            name: "Copper Ore",
            raw: true,
        }); // FactoryGame/Content/FactoryGame/Resource/RawResources/OreCopper/Desc_OreCopper
        item_registry.push(copper_ore.clone());
        let rotor = Rc::new(Item {
            name: "Rotor",
            raw: false,
        }); // FactoryGame/Content/FactoryGame/Resource/Parts/Rotor/Desc_Rotor
        ...
        let steel_beam = Rc::new(Item {
            name: "Steel Beam",
            raw: false,
        }); // FactoryGame/Content/FactoryGame/Resource/Parts/SteelPlate/Desc_SteelPlate
        ...
        let crude_oil = Rc::new(Item {
            name: "Crude Oil",
            raw: true,
        }); // FactoryGame/Content/FactoryGame/Resource/RawResources/CrudeOil/Desc_LiquidOil
        ...
        let stator = Rc::new(Item {
            name: "Stator",
            raw: false,
        }); // FactoryGame/Content/FactoryGame/Resource/Parts/Stator/Desc_Stator
        ...
        let fabric = Rc::new(Item {
            name: "Fabric",
            raw: false,
        }); // FactoryGame/Content/FactoryGame/Resource/Parts/GenericBiomass/Desc_Fabric
        ...
        let water = Rc::new(Item {
            name: "Water",
            raw: true,
        }); // FactoryGame/Content/FactoryGame/Resource/RawResources/Water/Desc_Water
        ...
        let raw_quartz = Rc::new(Item {
            name: "Raw Quartz",
            raw: true,
        }); // FactoryGame/Content/FactoryGame/Resource/RawResources/RawQuartz/Desc_RawQuartz
        item_registry.push(raw_quartz.clone());
        let fuel = Rc::new(Item {
            name: "Fuel",
            raw: false,
        }); // FactoryGame/Content/FactoryGame/Resource/Parts/Fuel/Desc_LiquidFuel
        item_registry.push(fuel.clone());
        let concrete = Rc::new(Item {
            name: "Concrete",
            raw: false,
        }); // FactoryGame/Content/FactoryGame/Resource/Parts/Cement/Desc_Cement
        item_registry.push(concrete.clone());
        let limestone = Rc::new(Item {
            name: "Limestone",
            raw: true,
        }); // FactoryGame/Content/FactoryGame/Resource/RawResources/Stone/Desc_Stone
        item_registry.push(limestone.clone());
        let iron_rod = Rc::new(Item {
            name: "Iron Rod",
            raw: false,
        }); // FactoryGame/Content/FactoryGame/Resource/Parts/IronRod/Desc_IronRod
        item_registry.push(iron_rod.clone());
        let turbofuel = Rc::new(Item {
            name: "Turbofuel",
            raw: false,
        }); // FactoryGame/Content/FactoryGame/Resource/Parts/Turbofuel/Desc_LiquidTurboFuel
        ...
        let motor = Rc::new(Item {
            name: "Motor",
            raw: false,
        }); // FactoryGame/Content/FactoryGame/Resource/Parts/Motor/Desc_Motor
        item_registry.push(motor.clone());
        let steel_pipe = Rc::new(Item {
            name: "Steel Pipe",
            raw: false,
        }); // FactoryGame/Content/FactoryGame/Resource/Parts/SteelPipe/Desc_SteelPipe
        item_registry.push(steel_pipe.clone());
        let battery = Rc::new(Item {
            name: "Battery",
            raw: false,
        }); // FactoryGame/Content/FactoryGame/Resource/Parts/Battery/Desc_Battery
        item_registry.push(battery.clone());
        let sulfur = Rc::new(Item {
            name: "Sulfur",
            raw: true,
        }); // FactoryGame/Content/FactoryGame/Resource/RawResources/Sulfur/Desc_Sulfur
        ...
        let heat_sink = Rc::new(Item {
            name: "Heat Sink",
            raw: false,
        }); // FactoryGame/Content/FactoryGame/Resource/Parts/AluminumPlateReinforced/Desc_AluminumPlateReinforced
        ...
        let uranium = Rc::new(Item {
            name: "Uranium",
            raw: true,
        }); // FactoryGame/Content/FactoryGame/Resource/RawResources/OreUranium/Desc_OreUranium
        ...
        let bauxite = Rc::new(Item {
            name: "Bauxite",
            raw: true,
        }); // FactoryGame/Content/FactoryGame/Resource/RawResources/OreBauxite/Desc_OreBauxite
        item_registry.push(bauxite.clone());
        let coal = Rc::new(Item {
            name: "Coal",
            raw: true,
        }); // FactoryGame/Content/FactoryGame/Resource/RawResources/Coal/Desc_Coal
        ...
        let computer = Rc::new(Item {
            name: "Computer",
            raw: false,
        }); // FactoryGame/Content/FactoryGame/Resource/Parts/Computer/Desc_Computer
        ...
        let beacon = Rc::new(Item {
            name: "Beacon",
            raw: false,
        }); // FactoryGame/Content/FactoryGame/Resource/Equipment/Beacon/BP_EquipmentDescriptorBeacon
        item_registry.push(beacon.clone());
        let quickwire = Rc::new(Item {
            name: "Quickwire",
            raw: false,
        }); // FactoryGame/Content/FactoryGame/Resource/Parts/HighSpeedWire/Desc_HighSpeedWire
        item_registry.push(quickwire.clone());
        let silica = Rc::new(Item {
            name: "Silica",
            raw: false,
        }); // FactoryGame/Content/FactoryGame/Resource/Parts/Silica/Desc_Silica
        item_registry.push(silica.clone());
        let wood = Rc::new(Item {
            name: "Wood",
            raw: false,
        }); // FactoryGame/Content/FactoryGame/Resource/Parts/GenericBiomass/Desc_Wood
        item_registry.push(wood.clone());
        let biomass = Rc::new(Item {
            name: "Biomass",
            raw: false,
        }); // FactoryGame/Content/FactoryGame/Resource/Parts/GenericBiomass/Desc_GenericBiomass
        item_registry.push(biomass.clone());
        let ailimiter = Rc::new(Item {
            name: "AI Limiter",
            raw: false,
        }); // FactoryGame/Content/FactoryGame/Resource/Parts/CircuitBoardHighSpeed/Desc_CircuitBoardHighSpeed
        ...
        let assembler = Rc::new(Item {
            name: "Assembler",
            raw: false,
        }); // FactoryGame/Content/FactoryGame/Buildable/Factory/AssemblerMk1/Desc_AssemblerMk1
        item_registry.push(assembler.clone());
        let blender = Rc::new(Item {
            name: "Blender",
            raw: false,
        }); // FactoryGame/Content/FactoryGame/Buildable/Factory/Blender/Desc_Blender
        ...
        let drone_port = Rc::new(Item {
            name: "Drone Port",
            raw: false,
        }); // FactoryGame/Content/FactoryGame/Buildable/Factory/DroneStation/Desc_DroneStation
        ...
        let jump_pad = Rc::new(Item {
            name: "Jump Pad",
            raw: false,
        }); // FactoryGame/Content/FactoryGame/Buildable/Factory/JumpPad/Desc_JumpPadAdjustable
        ...
        let mam = Rc::new(Item {
            name: "MAM",
            raw: false,
        }); // FactoryGame/Content/FactoryGame/Buildable/Factory/Mam/Desc_Mam
        ...
        let miner_mk_1 = Rc::new(Item {
            name: "Miner Mk.1",
            raw: false,
        }); // FactoryGame/Content/FactoryGame/Buildable/Factory/MinerMK1/Desc_MinerMk1
        item_registry.push(miner_mk_1.clone());
        let miner_mk_2 = Rc::new(Item {
            name: "Miner Mk.2",
            raw: false,
        }); // FactoryGame/Content/FactoryGame/Buildable/Factory/MinerMk2/Desc_MinerMk2
        item_registry.push(miner_mk_2.clone());
        let miner_mk_3 = Rc::new(Item {
            name: "Miner Mk.3",
            raw: false,
        }); // FactoryGame/Content/FactoryGame/Buildable/Factory/MinerMk3/Desc_MinerMk3
        ...
        let refinery = Rc::new(Item {
            name: "Refinery",
            raw: false,
        }); // FactoryGame/Content/FactoryGame/Buildable/Factory/OilRefinery/Desc_OilRefinery
        item_registry.push(refinery.clone());
        let packager = Rc::new(Item {
            name: "Packager",
            raw: false,
        }); // FactoryGame/Content/FactoryGame/Buildable/Factory/Packager/Desc_Packager
        item_registry.push(packager.clone());
        let hypertube = Rc::new(Item {
            name: "Hypertube",
            raw: false,
        }); // FactoryGame/Content/FactoryGame/Buildable/Factory/PipeHyper/Desc_PipeHyper
        ...
        let power_line = Rc::new(Item {
            name: "Power Line",
            raw: false,
        }); // FactoryGame/Content/FactoryGame/Buildable/Factory/PowerLine/Desc_PowerLine
        ...
        let railway = Rc::new(Item {
            name: "Railway",
            raw: false,
        }); // FactoryGame/Content/FactoryGame/Buildable/Factory/Train/Track/Desc_RailroadTrack
        ...
        let smelter = Rc::new(Item {
            name: "Smelter",
            raw: false,
        }); // FactoryGame/Content/FactoryGame/Buildable/Factory/SmelterMk1/Desc_SmelterMk1
        item_registry.push(smelter.clone());
        let foundry = Rc::new(Item {
            name: "Foundry",
            raw: false,
        }); // FactoryGame/Content/FactoryGame/Buildable/Factory/FoundryMk1/Desc_FoundryMk1
        ...
        let the_hub = Rc::new(Item {
            name: "The HUB",
            raw: false,
        }); // FactoryGame/Content/FactoryGame/Buildable/Factory/TradingPost/Desc_TradingPost
        item_registry.push(the_hub.clone());
        let hubparts = Rc::new(Item {
            name: "HUB Parts",
            raw: false,
        }); // FactoryGame/Content/FactoryGame/Resource/Parts/HUBParts/Desc_HUBParts
        ...
        let valve = Rc::new(Item {
            name: "Valve",
            raw: false,
        }); // FactoryGame/Content/FactoryGame/Buildable/Factory/PipeValve/Desc_Valve
        ...
        let pillar_top = Rc::new(Item {
            name: "Pillar Top",
            raw: false,
        }); // FactoryGame/Content/FactoryGame/Buildable/Building/Foundation/Desc_PillarTop
        ...
        let ladder = Rc::new(Item {
            name: "Ladder",
            raw: false,
        }); // FactoryGame/Content/FactoryGame/Buildable/Building/Ladder/Desc_Ladder
        item_registry.push(ladder.clone());
        let ramp1m = Rc::new(Item {
            name: "Ramp 1m",
            raw: false,
        }); // FactoryGame/Content/FactoryGame/Buildable/Building/Ramp/Desc_Ramp_8x1_01
        item_registry.push(ramp1m.clone());
        let ramp2m = Rc::new(Item {
            name: "Ramp 2m",
            raw: false,
        }); // FactoryGame/Content/FactoryGame/Buildable/Building/Ramp/Desc_Ramp_8x2_01
        item_registry.push(ramp2m.clone());
        let ramp4m = Rc::new(Item {
            name: "Ramp 4m",
            raw: false,
        }); // FactoryGame/Content/FactoryGame/Buildable/Building/Ramp/Desc_Ramp_8x4_01
        ...
        let frame_ramp = Rc::new(Item {
            name: "Frame Ramp",
            raw: false,
        }); // FactoryGame/Content/FactoryGame/Buildable/Building/Ramp/Desc_Ramp_Frame_01
        ...
        let roof_flat = Rc::new(Item {
            name: "Roof Flat",
            raw: false,
        }); // FactoryGame/Content/FactoryGame/Buildable/Building/Roof/Desc_Roof_A_01
        item_registry.push(roof_flat.clone());
        let roof1m = Rc::new(Item {
            name: "Roof 1m",
            raw: false,
        }); // FactoryGame/Content/FactoryGame/Buildable/Building/Roof/Desc_Roof_A_02
        item_registry.push(roof1m.clone());
        let roof2m = Rc::new(Item {
            name: "Roof 2m",
            raw: false,
        }); // FactoryGame/Content/FactoryGame/Buildable/Building/Roof/Desc_Roof_A_03
        item_registry.push(roof2m.clone());
        let roof4m = Rc::new(Item {
            name: "Roof 4m",
            raw: false,
        }); // FactoryGame/Content/FactoryGame/Buildable/Building/Roof/Desc_Roof_A_04
        ...
        let roof_flat = Rc::new(Item {
            name: "Roof Flat",
            raw: false,
        }); // FactoryGame/Content/FactoryGame/Buildable/Building/Roof/Desc_Roof_Orange_01
        item_registry.push(roof_flat.clone());
        let roof1m = Rc::new(Item {
            name: "Roof 1m",
            raw: false,
        }); // FactoryGame/Content/FactoryGame/Buildable/Building/Roof/Desc_Roof_Orange_02
        item_registry.push(roof1m.clone());
        let roof2m = Rc::new(Item {
            name: "Roof 2m",
            raw: false,
        }); // FactoryGame/Content/FactoryGame/Buildable/Building/Roof/Desc_Roof_Orange_03
        item_registry.push(roof2m.clone());
        let roof4m = Rc::new(Item {
            name: "Roof 4m",
            raw: false,
        }); // FactoryGame/Content/FactoryGame/Buildable/Building/Roof/Desc_Roof_Orange_04
        item_registry.push(roof4m.clone());
        let inner_corner_roof1m = Rc::new(Item {
            name: "Inner Corner Roof 1m",
            raw: false,
        ...
        let roof_flat = Rc::new(Item {
            name: "Roof Flat",
            raw: false,
        }); // FactoryGame/Content/FactoryGame/Buildable/Building/Roof/Desc_Roof_Tar_01
        item_registry.push(roof_flat.clone());
        let roof1m = Rc::new(Item {
            name: "Roof 1m",
            raw: false,
        }); // FactoryGame/Content/FactoryGame/Buildable/Building/Roof/Desc_Roof_Tar_02
        item_registry.push(roof1m.clone());
        let roof2m = Rc::new(Item {
            name: "Roof 2m",
            raw: false,
        }); // FactoryGame/Content/FactoryGame/Buildable/Building/Roof/Desc_Roof_Tar_03
        item_registry.push(roof2m.clone());
        let roof4m = Rc::new(Item {
            name: "Roof 4m",
            raw: false,
        }); // FactoryGame/Content/FactoryGame/Buildable/Building/Roof/Desc_Roof_Tar_04
        item_registry.push(roof4m.clone());
        let inner_corner_roof1m = Rc::new(Item {
            name: "Inner Corner Roof 1m",
            raw: false,
        ...
        let roof_flat = Rc::new(Item {
            name: "Roof Flat",
            raw: false,
        }); // FactoryGame/Content/FactoryGame/Buildable/Building/Roof/Desc_Roof_Window_01
        item_registry.push(roof_flat.clone());
        let roof1m = Rc::new(Item {
            name: "Roof 1m",
            raw: false,
        }); // FactoryGame/Content/FactoryGame/Buildable/Building/Roof/Desc_Roof_Window_02
        item_registry.push(roof1m.clone());
        let roof2m = Rc::new(Item {
            name: "Roof 2m",
            raw: false,
        }); // FactoryGame/Content/FactoryGame/Buildable/Building/Roof/Desc_Roof_Window_03
        item_registry.push(roof2m.clone());
        let roof4m = Rc::new(Item {
            name: "Roof 4m",
            raw: false,
        }); // FactoryGame/Content/FactoryGame/Buildable/Building/Roof/Desc_Roof_Window_04
        item_registry.push(roof4m.clone());
        let inner_corner_roof1m = Rc::new(Item {
            name: "Inner Corner Roof 1m",
            raw: false,
        ...
        item_registry.push(side_door_wall.clone());
        let frame_wall = Rc::new(Item {
            name: "Frame Wall",
            raw: false,
        }); // FactoryGame/Content/FactoryGame/Buildable/Building/Wall/Desc_Wall_Frame_01
        ...
        let leaves = Rc::new(Item {
            name: "Leaves",
            raw: false,
        }); // FactoryGame/Content/FactoryGame/Resource/Parts/GenericBiomass/Desc_Leaves
        item_registry.push(leaves.clone());
        let mycelia = Rc::new(Item {
            name: "Mycelia",
            raw: false,
        }); // FactoryGame/Content/FactoryGame/Resource/Parts/GenericBiomass/Desc_Mycelia
        ...
        let candy_cane = Rc::new(Item {
            name: "Candy Cane",
            raw: false,
        }); // FactoryGame/Content/FactoryGame/Events/Christmas/Parts/Desc_CandyCane
        ...
        let rifle_ammo = Rc::new(Item {
            name: "Rifle Ammo",
            raw: false,
        }); // FactoryGame/Content/FactoryGame/Resource/Parts/CartridgeStandard/Desc_CartridgeStandard
        ...
        let chainsaw = Rc::new(Item {
            name: "Chainsaw",
            raw: false,
        }); // FactoryGame/Content/FactoryGame/Equipment/Chainsaw/Desc_Chainsaw
        ...
        let gas_filter = Rc::new(Item {
            name: "Gas Filter",
            raw: false,
        }); // FactoryGame/Content/FactoryGame/Resource/Parts/Filter/Desc_Filter
        ...
        let gas_mask = Rc::new(Item {
            name: "Gas Mask",
            raw: false,
        }); // FactoryGame/Content/FactoryGame/Resource/Equipment/GasMask/BP_EquipmentDescriptorGasmask
        ...
        let hover_pack = Rc::new(Item {
            name: "Hover Pack",
            raw: false,
        }); // FactoryGame/Content/FactoryGame/Resource/Equipment/HoverPack/BP_EquipmentDescriptorHoverPack
        item_registry.push(hover_pack.clone());
        let jetpack = Rc::new(Item {
            name: "Jetpack",
            raw: false,
        }); // FactoryGame/Content/FactoryGame/Resource/Equipment/JetPack/BP_EquipmentDescriptorJetPack
        ...
        let paleberry = Rc::new(Item {
            name: "Paleberry",
            raw: false,
        }); // FactoryGame/Content/FactoryGame/Resource/Environment/Berry/Desc_Berry
        item_registry.push(paleberry.clone());
        let beryl_nut = Rc::new(Item {
            name: "Beryl Nut",
            raw: false,
        }); // FactoryGame/Content/FactoryGame/Resource/Environment/Nut/Desc_Nut
        item_registry.push(beryl_nut.clone());
        let nobelisk = Rc::new(Item {
            name: "Nobelisk",
            raw: false,
        }); // FactoryGame/Content/FactoryGame/Resource/Parts/NobeliskExplosive/Desc_NobeliskExplosive
        ...
        let parachute = Rc::new(Item {
            name: "Parachute",
            raw: false,
        }); // FactoryGame/Content/FactoryGame/Resource/Equipment/Beacon/Desc_Parachute
        item_registry.push(parachute.clone());
        let rebar_gun = Rc::new(Item {
            name: "Rebar Gun",
            raw: false,
        }); // FactoryGame/Content/FactoryGame/Resource/Equipment/NailGun/Desc_RebarGunProjectile
        item_registry.push(rebar_gun.clone());
        let rifle = Rc::new(Item {
            name: "Rifle",
            raw: false,
        }); // FactoryGame/Content/FactoryGame/Resource/Equipment/Rifle/BP_EquipmentDescriptorRifle
        item_registry.push(rifle.clone());
        let iron_rebar = Rc::new(Item {
            name: "Iron Rebar",
            raw: false,
        }); // FactoryGame/Content/FactoryGame/Resource/Parts/SpikedRebar/Desc_SpikedRebar
        ...
        let zipline = Rc::new(Item {
            name: "Zipline",
            raw: false,
        }); // FactoryGame/Content/FactoryGame/Resource/Equipment/Zipline/BP_EqDescZipLine
        item_registry.push(zipline.clone());
        let snowball = Rc::new(Item {
            name: "Snowball",
            raw: false,
        }); // FactoryGame/Content/FactoryGame/Resource/Parts/SnowballProjectile/Desc_SnowballProjectile
        ...
        let alternate_adhered_iron_plate_recipe = Recipe {
            ...
            alternate: true,
        }; // FactoryGame/Content/FactoryGame/Recipes/AlternateRecipes/New_Update3/Recipe_Alternate_AdheredIronPlate
        recipe_registry
        ...
        let alternate_bolted_frame_recipe = Recipe {
            ...
            alternate: true,
        }; // FactoryGame/Content/FactoryGame/Recipes/AlternateRecipes/New_Update3/Recipe_Alternate_BoltedFrame
        recipe_registry
            .entry("Modular Frame")
            .or_insert_with(Vec::new)
        ...
        let alternate_coated_cable_recipe = Recipe {
            ...
            alternate: true,
        }; // FactoryGame/Content/FactoryGame/Recipes/AlternateRecipes/New_Update3/Recipe_Alternate_CoatedCable
        recipe_registry
            .entry("Cable")
            .or_insert_with(Vec::new)
        ...
        let alternate_coated_iron_canister_recipe = Recipe {
            ...
            alternate: true,
        }; // FactoryGame/Content/FactoryGame/Recipes/AlternateRecipes/New_Update3/Recipe_Alternate_CoatedIronCanister
        recipe_registry
        ...
        let alternate_coated_iron_plate_recipe = Recipe {
            ...
            alternate: true,
        }; // FactoryGame/Content/FactoryGame/Recipes/AlternateRecipes/New_Update3/Recipe_Alternate_CoatedIronPlate
        recipe_registry
            .entry("Iron Plate")
            .or_insert_with(Vec::new)
        ...
        let alternate_coke_steel_ingot_recipe = Recipe {
            ...
            manufacturing_duration: 12f32,
            alternate: true,
        }; // FactoryGame/Content/FactoryGame/Recipes/AlternateRecipes/New_Update3/Recipe_Alternate_CokeSteelIngot
        recipe_registry
            .entry("Steel Ingot")
            .or_insert_with(Vec::new)
        ...
        let alternate_copper_alloy_ingot_recipe = Recipe {
            ...
            manufacturing_duration: 12f32,
            alternate: true,
        }; // FactoryGame/Content/FactoryGame/Recipes/AlternateRecipes/New_Update3/Recipe_Alternate_CopperAlloyIngot
        recipe_registry
            .entry("Copper Ingot")
            .or_insert_with(Vec::new)
        ...
        let alternate_copper_rotor_recipe = Recipe {
            ...
            manufacturing_duration: 16f32,
            alternate: true,
        }; // FactoryGame/Content/FactoryGame/Recipes/AlternateRecipes/New_Update3/Recipe_Alternate_CopperRotor
        recipe_registry
            .entry("Rotor")
            .or_insert_with(Vec::new)
        ...
        let alternate_diluted_packaged_fuel_recipe = Recipe {
            ...
            alternate: true,
        }; // FactoryGame/Content/FactoryGame/Recipes/AlternateRecipes/New_Update3/Recipe_Alternate_DilutedPackagedFuel
        recipe_registry
            .entry("Packaged Fuel")
            .or_insert_with(Vec::new)
        ...
        let alternate_electrode_aluminum_scrap_recipe = Recipe {
            ...
            manufacturing_duration: 4f32,
            alternate: true,
        }; // FactoryGame/Content/FactoryGame/Recipes/AlternateRecipes/New_Update3/Recipe_Alternate_ElectroAluminumScrap
        recipe_registry
        ...
        let alternate_electrode_circuit_board_recipe = Recipe {
            ...
            manufacturing_duration: 12f32,
            alternate: true,
        }; // FactoryGame/Content/FactoryGame/Recipes/AlternateRecipes/New_Update3/Recipe_Alternate_ElectrodeCircuitBoard
        recipe_registry
            .entry("Circuit Board")
            .or_insert_with(Vec::new)
        ...
        let alternate_flexible_framework_recipe = Recipe {
            ...
            manufacturing_duration: 16f32,
            alternate: true,
        }; // FactoryGame/Content/FactoryGame/Recipes/AlternateRecipes/New_Update3/Recipe_Alternate_FlexibleFramework
        recipe_registry
        ...
        let alternate_fused_wire_recipe = Recipe {
            ...
            alternate: true,
        }; // FactoryGame/Content/FactoryGame/Recipes/AlternateRecipes/New_Update3/Recipe_Alternate_FusedWire
        recipe_registry
            .entry("Wire")
            .or_insert_with(Vec::new)
        ...
        let alternate_heavy_flexible_frame_recipe = Recipe {
            ...
            manufacturing_duration: 16f32,
            alternate: true,
        }; // FactoryGame/Content/FactoryGame/Recipes/AlternateRecipes/New_Update3/Recipe_Alternate_HeavyFlexibleFrame
        recipe_registry
        ...
        let alternate_heavy_oil_residue_recipe = Recipe {
            ...
            alternate: true,
        }; // FactoryGame/Content/FactoryGame/Recipes/AlternateRecipes/New_Update3/Recipe_Alternate_HeavyOilResidue
        recipe_registry
        ...
        let alternate_automated_speed_wiring_recipe = Recipe {
            ...
            alternate: true,
        }; // FactoryGame/Content/FactoryGame/Recipes/AlternateRecipes/New_Update3/Recipe_Alternate_HighSpeedWiring
        recipe_registry
        ...
        let alternate_plastic_smart_plating_recipe = Recipe {
            ...
            manufacturing_duration: 24f32,
            alternate: true,
        }; // FactoryGame/Content/FactoryGame/Recipes/AlternateRecipes/New_Update3/Recipe_Alternate_PlasticSmartPlating
        recipe_registry
            .entry("Smart Plating")
            .or_insert_with(Vec::new)
        ...
        let alternate_polyester_fabric_recipe = Recipe {
            ...
            manufacturing_duration: 2f32,
            alternate: true,
        }; // FactoryGame/Content/FactoryGame/Recipes/AlternateRecipes/New_Update3/Recipe_Alternate_PolyesterFabric
        recipe_registry
            .entry("Fabric")
            .or_insert_with(Vec::new)
        ...
        let alternate_polymer_resin_recipe = Recipe {
            ...
            manufacturing_duration: 6f32,
            alternate: true,
        }; // FactoryGame/Content/FactoryGame/Recipes/AlternateRecipes/New_Update3/Recipe_Alternate_PolymerResin
        recipe_registry
            .entry("Polymer Resin")
            .or_insert_with(Vec::new)
        ...
        let alternate_pure_caterium_ingot_recipe = Recipe {
            ...
            alternate: true,
        }; // FactoryGame/Content/FactoryGame/Recipes/AlternateRecipes/New_Update3/Recipe_Alternate_PureCateriumIngot
        recipe_registry
        ...
        let alternate_pure_copper_ingot_recipe = Recipe {
            ...
            manufacturing_duration: 24f32,
            alternate: true,
        }; // FactoryGame/Content/FactoryGame/Recipes/AlternateRecipes/New_Update3/Recipe_Alternate_PureCopperIngot
        recipe_registry
            .entry("Copper Ingot")
            .or_insert_with(Vec::new)
        ...
        let alternate_pure_iron_ingot_recipe = Recipe {
            ...
            manufacturing_duration: 12f32,
            alternate: true,
        }; // FactoryGame/Content/FactoryGame/Recipes/AlternateRecipes/New_Update3/Recipe_Alternate_PureIronIngot
        recipe_registry
            .entry("Iron Ingot")
            .or_insert_with(Vec::new)
        ...
        let alternate_pure_quartz_crystal_recipe = Recipe {
            ...
            manufacturing_duration: 8f32,
            alternate: true,
        }; // FactoryGame/Content/FactoryGame/Recipes/AlternateRecipes/New_Update3/Recipe_Alternate_PureQuartzCrystal
        recipe_registry
        ...
        let alternate_recycled_rubber_recipe = Recipe {
            ...
            manufacturing_duration: 12f32,
            alternate: true,
        }; // FactoryGame/Content/FactoryGame/Recipes/AlternateRecipes/New_Update3/Recipe_Alternate_RecycledRubber
        recipe_registry
            .entry("Rubber")
            .or_insert_with(Vec::new)
        ...
        let alternate_rubber_concrete_recipe = Recipe {
            ...
            manufacturing_duration: 12f32,
            alternate: true,
        }; // FactoryGame/Content/FactoryGame/Recipes/AlternateRecipes/New_Update3/Recipe_Alternate_RubberConcrete
        recipe_registry
            .entry("Concrete")
            .or_insert_with(Vec::new)
        ...
        let alternate_steamed_copper_sheet_recipe = Recipe {
            ...
            manufacturing_duration: 8f32,
            alternate: true,
        }; // FactoryGame/Content/FactoryGame/Recipes/AlternateRecipes/New_Update3/Recipe_Alternate_SteamedCopperSheet
        recipe_registry
            .entry("Copper Sheet")
            .or_insert_with(Vec::new)
        ...
        let alternate_steel_canister_recipe = Recipe {
            ...
            alternate: true,
        }; // FactoryGame/Content/FactoryGame/Recipes/AlternateRecipes/New_Update3/Recipe_Alternate_SteelCanister
        recipe_registry
            .entry("Empty Canister")
            .or_insert_with(Vec::new)
        ...
        let alternate_steel_coated_plate_recipe = Recipe {
            ...
            manufacturing_duration: 24f32,
            alternate: true,
        }; // FactoryGame/Content/FactoryGame/Recipes/AlternateRecipes/New_Update3/Recipe_Alternate_SteelCoatedPlate
        recipe_registry
            .entry("Iron Plate")
            .or_insert_with(Vec::new)
        ...
        let alternate_steel_rod_recipe = Recipe {
            ...
            manufacturing_duration: 5f32,
            alternate: true,
        }; // FactoryGame/Content/FactoryGame/Recipes/AlternateRecipes/New_Update3/Recipe_Alternate_SteelRod
        recipe_registry
            .entry("Iron Rod")
            .or_insert_with(Vec::new)
        ...
        let alternate_turbo_heavy_fuel_recipe = Recipe {
            ...
            manufacturing_duration: 8f32,
            alternate: true,
        }; // FactoryGame/Content/FactoryGame/Recipes/AlternateRecipes/New_Update3/Recipe_Alternate_TurboHeavyFuel
        recipe_registry
            .entry("Turbofuel")
            .or_insert_with(Vec::new)
        ...
        let alternate_wet_concrete_recipe = Recipe {
            ...
            manufacturing_duration: 3f32,
            alternate: true,
        }; // FactoryGame/Content/FactoryGame/Recipes/AlternateRecipes/New_Update3/Recipe_Alternate_WetConcrete
        recipe_registry
            .entry("Concrete")
            .or_insert_with(Vec::new)
        ...
        let alternate_pure_aluminum_ingot_recipe = Recipe {
            ...
            manufacturing_duration: 2f32,
            alternate: true,
        }; // FactoryGame/Content/FactoryGame/Recipes/AlternateRecipes/New_Update3/Recipe_PureAluminumIngot
        recipe_registry
        ...
        let alternate_alclad_casing_recipe = Recipe {
            ...
            manufacturing_duration: 8f32,
            alternate: true,
        }; // FactoryGame/Content/FactoryGame/Recipes/AlternateRecipes/New_Update4/Recipe_Alternate_AlcladCasing
        recipe_registry
        ...
        let alternate_automated_miner_recipe = Recipe {
            ...
            alternate: true,
        }; // FactoryGame/Content/FactoryGame/Recipes/AlternateRecipes/New_Update4/Recipe_Alternate_AutomatedMiner
        recipe_registry
        ...
        let alternate_classic_battery_recipe = Recipe {
            ...
            manufacturing_duration: 8f32,
            alternate: true,
        }; // FactoryGame/Content/FactoryGame/Recipes/AlternateRecipes/New_Update4/Recipe_Alternate_ClassicBattery
        recipe_registry
            .entry("Battery")
            .or_insert_with(Vec::new)
        ...
        let alternate_cooling_device_recipe = Recipe {
            ...
            manufacturing_duration: 32f32,
            alternate: true,
        }; // FactoryGame/Content/FactoryGame/Recipes/AlternateRecipes/New_Update4/Recipe_Alternate_CoolingDevice
        recipe_registry
        ...
        let alternate_diluted_fuel_recipe = Recipe {
            ...
            manufacturing_duration: 6f32,
            alternate: true,
        }; // FactoryGame/Content/FactoryGame/Recipes/AlternateRecipes/New_Update4/Recipe_Alternate_DilutedFuel
        recipe_registry
            .entry("Fuel")
            .or_insert_with(Vec::new)
        ...
        let alternate_electric_motor_recipe = Recipe {
            ...
            manufacturing_duration: 16f32,
            alternate: true,
        }; // FactoryGame/Content/FactoryGame/Recipes/AlternateRecipes/New_Update4/Recipe_Alternate_ElectricMotor
        recipe_registry
            .entry("Motor")
            .or_insert_with(Vec::new)
        ...
        let alternate_fertile_uranium_recipe = Recipe {
            ...
            manufacturing_duration: 12f32,
            alternate: true,
        }; // FactoryGame/Content/FactoryGame/Recipes/AlternateRecipes/New_Update4/Recipe_Alternate_FertileUranium
        recipe_registry
        ...
        let alternate_heat_fused_frame_recipe = Recipe {
            ...
            manufacturing_duration: 20f32,
            alternate: true,
        }; // FactoryGame/Content/FactoryGame/Recipes/AlternateRecipes/New_Update4/Recipe_Alternate_HeatFusedFrame
        recipe_registry
        ...
        let alternate_instant_scrap_recipe = Recipe {
            ...
            manufacturing_duration: 6f32,
            alternate: true,
        }; // FactoryGame/Content/FactoryGame/Recipes/AlternateRecipes/New_Update4/Recipe_Alternate_InstantScrap
        recipe_registry
            .entry("Aluminum Scrap")
            .or_insert_with(Vec::new)
        ...
        let alternate_ocsupercomputer_recipe = Recipe {
            ...
            manufacturing_duration: 20f32,
            alternate: true,
        }; // FactoryGame/Content/FactoryGame/Recipes/AlternateRecipes/New_Update4/Recipe_Alternate_OCSupercomputer
        recipe_registry
            .entry("Supercomputer")
            .or_insert_with(Vec::new)
        ...
        let alternate_plutonium_fuel_unit_recipe = Recipe {
            ...
            alternate: true,
        }; // FactoryGame/Content/FactoryGame/Recipes/AlternateRecipes/New_Update4/Recipe_Alternate_PlutoniumFuelUnit
        recipe_registry
        ...
        let alternate_radio_control_system_recipe = Recipe {
            ...
            alternate: true,
        }; // FactoryGame/Content/FactoryGame/Recipes/AlternateRecipes/New_Update4/Recipe_Alternate_RadioControlSystem
        recipe_registry
        ...
        let alternate_sloppy_alumina_recipe = Recipe {
            ...
            manufacturing_duration: 3f32,
            alternate: true,
        }; // FactoryGame/Content/FactoryGame/Recipes/AlternateRecipes/New_Update4/Recipe_Alternate_SloppyAlumina
        recipe_registry
        ...
        let alternate_super_state_computer_recipe = Recipe {
            ...
            alternate: true,
        }; // FactoryGame/Content/FactoryGame/Recipes/AlternateRecipes/New_Update4/Recipe_Alternate_SuperStateComputer
        recipe_registry
            .entry("Supercomputer")
            .or_insert_with(Vec::new)
        ...
        let alternate_turbo_blend_fuel_recipe = Recipe {
            ...
            manufacturing_duration: 8f32,
            alternate: true,
        }; // FactoryGame/Content/FactoryGame/Recipes/AlternateRecipes/New_Update4/Recipe_Alternate_TurboBlendFuel
        recipe_registry
            .entry("Turbofuel")
            .or_insert_with(Vec::new)
        ...
        let alternate_turbo_pressure_motor_recipe = Recipe {
            ...
            manufacturing_duration: 32f32,
            alternate: true,
        }; // FactoryGame/Content/FactoryGame/Recipes/AlternateRecipes/New_Update4/Recipe_Alternate_TurboPressureMotor
        recipe_registry
            .entry("Turbo Motor")
            .or_insert_with(Vec::new)
        ...
        let alternate_crystal_beacon_recipe = Recipe {
            ...
            manufacturing_duration: 120f32,
            alternate: true,
        }; // FactoryGame/Content/FactoryGame/Recipes/AlternateRecipes/Parts/Recipe_Alternate_Beacon_1
        recipe_registry
            .entry("Beacon")
            .or_insert_with(Vec::new)
        ...
        let alternate_insulated_cable_recipe = Recipe {
            ...
            manufacturing_duration: 12f32,
            alternate: true,
        }; // FactoryGame/Content/FactoryGame/Recipes/AlternateRecipes/Parts/Recipe_Alternate_Cable_1
        recipe_registry
            .entry("Cable")
            .or_insert_with(Vec::new)
        ...
        let alternate_quickwire_cable_recipe = Recipe {
            ...
            manufacturing_duration: 24f32,
            alternate: true,
        }; // FactoryGame/Content/FactoryGame/Recipes/AlternateRecipes/Parts/Recipe_Alternate_Cable_2
        recipe_registry
            .entry("Cable")
            .or_insert_with(Vec::new)
        ...
        let alternate_silicon_circuit_board_recipe = Recipe {
            ...
            manufacturing_duration: 24f32,
            alternate: true,
        }; // FactoryGame/Content/FactoryGame/Recipes/AlternateRecipes/Parts/Recipe_Alternate_CircuitBoard_1
        recipe_registry
            .entry("Circuit Board")
            .or_insert_with(Vec::new)
        ...
        let alternate_caterium_circuit_board_recipe = Recipe {
            ...
            alternate: true,
        }; // FactoryGame/Content/FactoryGame/Recipes/AlternateRecipes/Parts/Recipe_Alternate_CircuitBoard_2
        recipe_registry
            .entry("Circuit Board")
            .or_insert_with(Vec::new)
        ...
        let alternate_charcoal_recipe = Recipe {
            ...
            manufacturing_duration: 4f32,
            alternate: true,
        }; // FactoryGame/Content/FactoryGame/Recipes/AlternateRecipes/Parts/Recipe_Alternate_Coal_1
        recipe_registry
            .entry("Coal")
            .or_insert_with(Vec::new)
        ...
        let alternate_biocoal_recipe = Recipe {
            ...
            manufacturing_duration: 8f32,
            alternate: true,
        }; // FactoryGame/Content/FactoryGame/Recipes/AlternateRecipes/Parts/Recipe_Alternate_Coal_2
        recipe_registry
            .entry("Coal")
            .or_insert_with(Vec::new)
        ...
        let alternate_caterium_computer_recipe = Recipe {
            ...
            manufacturing_duration: 16f32,
            alternate: true,
        }; // FactoryGame/Content/FactoryGame/Recipes/AlternateRecipes/Parts/Recipe_Alternate_Computer_1
        recipe_registry
            .entry("Computer")
            .or_insert_with(Vec::new)
        ...
        let alternate_crystal_computer_recipe = Recipe {
            ...
            alternate: true,
        }; // FactoryGame/Content/FactoryGame/Recipes/AlternateRecipes/Parts/Recipe_Alternate_Computer_2
        recipe_registry
            .entry("Computer")
            .or_insert_with(Vec::new)
        ...
        let alternate_fine_concrete_recipe = Recipe {
            ...
            manufacturing_duration: 24f32,
            alternate: true,
        }; // FactoryGame/Content/FactoryGame/Recipes/AlternateRecipes/Parts/Recipe_Alternate_Concrete
        recipe_registry
            .entry("Concrete")
            .or_insert_with(Vec::new)
        ...
        let alternate_insulated_crystal_oscillator_recipe = Recipe {
            ...
            manufacturing_duration: 32f32,
            alternate: true,
        }; // FactoryGame/Content/FactoryGame/Recipes/AlternateRecipes/Parts/Recipe_Alternate_CrystalOscillator
        recipe_registry
        ...
        let alternate_electromagnetic_connection_rod_recipe = Recipe {
            ...
            alternate: true,
        }; // FactoryGame/Content/FactoryGame/Recipes/AlternateRecipes/Parts/Recipe_Alternate_ElectromagneticControlRod_1
        recipe_registry
        ...
        let alternate_encased_industrial_pipe_recipe = Recipe {
            ...
            manufacturing_duration: 15f32,
            alternate: true,
        }; // FactoryGame/Content/FactoryGame/Recipes/AlternateRecipes/Parts/Recipe_Alternate_EncasedIndustrialBeam
        recipe_registry
        ...
        let alternate_compacted_coal_recipe = Recipe {
            ...
            manufacturing_duration: 12f32,
            alternate: true,
        }; // FactoryGame/Content/FactoryGame/Recipes/AlternateRecipes/Parts/Recipe_Alternate_EnrichedCoal
        recipe_registry
        ...
        let alternate_fine_black_powder_recipe = Recipe {
            ...
            manufacturing_duration: 16f32,
            alternate: true,
        }; // FactoryGame/Content/FactoryGame/Recipes/AlternateRecipes/Parts/Recipe_Alternate_Gunpowder_1
        recipe_registry
            .entry("Black Powder")
            .or_insert_with(Vec::new)
        ...
        let alternate_heat_exchanger_recipe = Recipe {
            ...
            manufacturing_duration: 6f32,
            alternate: true,
        }; // FactoryGame/Content/FactoryGame/Recipes/AlternateRecipes/Parts/Recipe_Alternate_HeatSink_1
        recipe_registry
            .entry("Heat Sink")
            .or_insert_with(Vec::new)
        ...
        let alternate_silicon_high_speed_connector_recipe = Recipe {
            ...
            manufacturing_duration: 40f32,
            alternate: true,
        }; // FactoryGame/Content/FactoryGame/Recipes/AlternateRecipes/Parts/Recipe_Alternate_HighSpeedConnector
        recipe_registry
        ...
        let alternate_iron_alloy_ingot_recipe = Recipe {
            ...
            manufacturing_duration: 6f32,
            alternate: true,
        }; // FactoryGame/Content/FactoryGame/Recipes/AlternateRecipes/Parts/Recipe_Alternate_IngotIron
        recipe_registry
            .entry("Iron Ingot")
            .or_insert_with(Vec::new)
        ...
        let alternate_solid_steel_ingot_recipe = Recipe {
            ...
            manufacturing_duration: 3f32,
            alternate: true,
        }; // FactoryGame/Content/FactoryGame/Recipes/AlternateRecipes/Parts/Recipe_Alternate_IngotSteel_1
        recipe_registry
            .entry("Steel Ingot")
            .or_insert_with(Vec::new)
        ...
        let alternate_compacted_steel_ingot_recipe = Recipe {
            ...
            manufacturing_duration: 16f32,
            alternate: true,
        }; // FactoryGame/Content/FactoryGame/Recipes/AlternateRecipes/Parts/Recipe_Alternate_IngotSteel_2
        recipe_registry
            .entry("Steel Ingot")
            .or_insert_with(Vec::new)
        ...
        let alternate_steeled_frame_recipe = Recipe {
            ...
            manufacturing_duration: 60f32,
            alternate: true,
        }; // FactoryGame/Content/FactoryGame/Recipes/AlternateRecipes/Parts/Recipe_Alternate_ModularFrame
        recipe_registry
            .entry("Modular Frame")
            .or_insert_with(Vec::new)
        ...
        let alternate_heavy_encased_frame_recipe = Recipe {
            ...
            manufacturing_duration: 64f32,
            alternate: true,
        }; // FactoryGame/Content/FactoryGame/Recipes/AlternateRecipes/Parts/Recipe_Alternate_ModularFrameHeavy
        recipe_registry
            .entry("Heavy Modular Frame")
            .or_insert_with(Vec::new)
        ...
        let alternate_rigour_motor_recipe = Recipe {
            ...
            manufacturing_duration: 48f32,
            alternate: true,
        }; // FactoryGame/Content/FactoryGame/Recipes/AlternateRecipes/Parts/Recipe_Alternate_Motor_1
        recipe_registry
            .entry("Motor")
            .or_insert_with(Vec::new)
        ...
        let alternate_uranium_fuel_unit_recipe = Recipe {
            ...
            alternate: true,
        }; // FactoryGame/Content/FactoryGame/Recipes/AlternateRecipes/Parts/Recipe_Alternate_NuclearFuelRod_1
        recipe_registry
        ...
        let alternate_recycled_plastic_recipe = Recipe {
            ...
            manufacturing_duration: 12f32,
            alternate: true,
        }; // FactoryGame/Content/FactoryGame/Recipes/AlternateRecipes/Parts/Recipe_Alternate_Plastic_1
        recipe_registry
            .entry("Plastic")
            .or_insert_with(Vec::new)
        ...
        let alternate_fused_quickwire_recipe = Recipe {
            ...
            manufacturing_duration: 8f32,
            alternate: true,
        }; // FactoryGame/Content/FactoryGame/Recipes/AlternateRecipes/Parts/Recipe_Alternate_Quickwire
        recipe_registry
            .entry("Quickwire")
            .or_insert_with(Vec::new)
        ...
        let alternate_radio_connection_unit_recipe = Recipe {
            ...
            manufacturing_duration: 16f32,
            alternate: true,
        }; // FactoryGame/Content/FactoryGame/Recipes/AlternateRecipes/Parts/Recipe_Alternate_RadioControlUnit_1
        recipe_registry
            .entry("Radio Control Unit")
            .or_insert_with(Vec::new)
        ...
        let alternate_bolted_iron_plate_recipe = Recipe {
            ...
            manufacturing_duration: 12f32,
            alternate: true,
        }; // FactoryGame/Content/FactoryGame/Recipes/AlternateRecipes/Parts/Recipe_Alternate_ReinforcedIronPlate_1
        recipe_registry
            .entry("Reinforced Iron Plate")
            .or_insert_with(Vec::new)
        ...
        let alternate_stitched_iron_plate_recipe = Recipe {
            ...
            manufacturing_duration: 32f32,
            alternate: true,
        }; // FactoryGame/Content/FactoryGame/Recipes/AlternateRecipes/Parts/Recipe_Alternate_ReinforcedIronPlate_2
        recipe_registry
            .entry("Reinforced Iron Plate")
            .or_insert_with(Vec::new)
        ...
        let alternate_steel_rotor_recipe = Recipe {
            ...
            manufacturing_duration: 12f32,
            alternate: true,
        }; // FactoryGame/Content/FactoryGame/Recipes/AlternateRecipes/Parts/Recipe_Alternate_Rotor
        recipe_registry
            .entry("Rotor")
            .or_insert_with(Vec::new)
        ...
        let alternate_cast_screw_recipe = Recipe {
            ...
            manufacturing_duration: 24f32,
            alternate: true,
        }; // FactoryGame/Content/FactoryGame/Recipes/AlternateRecipes/Parts/Recipe_Alternate_Screw
        recipe_registry
            .entry("Screw")
            .or_insert_with(Vec::new)
        ...
        let alternate_steel_screw_recipe = Recipe {
            ...
            manufacturing_duration: 12f32,
            alternate: true,
        }; // FactoryGame/Content/FactoryGame/Recipes/AlternateRecipes/Parts/Recipe_Alternate_Screw_2
        recipe_registry
            .entry("Screw")
            .or_insert_with(Vec::new)
        ...
        let alternate_cheap_silica_recipe = Recipe {
            ...
            manufacturing_duration: 16f32,
            alternate: true,
        }; // FactoryGame/Content/FactoryGame/Recipes/AlternateRecipes/Parts/Recipe_Alternate_Silica
        recipe_registry
            .entry("Silica")
            .or_insert_with(Vec::new)
        ...
        let alternate_quickwire_stator_recipe = Recipe {
            ...
            manufacturing_duration: 15f32,
            alternate: true,
        }; // FactoryGame/Content/FactoryGame/Recipes/AlternateRecipes/Parts/Recipe_Alternate_Stator
        recipe_registry
            .entry("Stator")
            .or_insert_with(Vec::new)
        ...
        let turbofuel_recipe = Recipe {
            ...
            manufacturing_duration: 16f32,
            alternate: true,
        }; // FactoryGame/Content/FactoryGame/Recipes/AlternateRecipes/Parts/Recipe_Alternate_Turbofuel
        recipe_registry
            .entry("Turbofuel")
            .or_insert_with(Vec::new)
        ...
        let alternate_turbo_electric_motor_recipe = Recipe {
            ...
            manufacturing_duration: 64f32,
            alternate: true,
        }; // FactoryGame/Content/FactoryGame/Recipes/AlternateRecipes/Parts/Recipe_Alternate_TurboMotor_1
        recipe_registry
            .entry("Turbo Motor")
            .or_insert_with(Vec::new)
        ...
        let alternate_infused_uranium_cell_recipe = Recipe {
            ...
            manufacturing_duration: 12f32,
            alternate: true,
        }; // FactoryGame/Content/FactoryGame/Recipes/AlternateRecipes/Parts/Recipe_Alternate_UraniumCell_1
        recipe_registry
        ...
        let alternate_iron_wire_recipe = Recipe {
            ...
            manufacturing_duration: 24f32,
            alternate: true,
        }; // FactoryGame/Content/FactoryGame/Recipes/AlternateRecipes/Parts/Recipe_Alternate_Wire_1
        recipe_registry
            .entry("Wire")
            .or_insert_with(Vec::new)
        ...
        let alternate_caterium_wire_recipe = Recipe {
            ...
            manufacturing_duration: 4f32,
            alternate: true,
        }; // FactoryGame/Content/FactoryGame/Recipes/AlternateRecipes/Parts/Recipe_Alternate_Wire_2
        recipe_registry
            .entry("Wire")
            .or_insert_with(Vec::new)
        ...
        let biomass_recipe = Recipe {
            ...
            manufacturing_duration: 5f32,
            alternate: false,
        }; // FactoryGame/Content/FactoryGame/Recipes/Constructor/Recipe_Biomass_Leaves
        recipe_registry
            .entry("Biomass")
            .or_insert_with(Vec::new)
            .push(biomass_recipe);
        let biomass_recipe = Recipe {
            ...
            manufacturing_duration: 4f32,
            alternate: false,
        }; // FactoryGame/Content/FactoryGame/Recipes/Constructor/Recipe_Biomass_Mycelia
        recipe_registry
            .entry("Biomass")
            .or_insert_with(Vec::new)
            .push(biomass_recipe);
        let biomass_recipe = Recipe {
            ...
            manufacturing_duration: 4f32,
            alternate: false,
        }; // FactoryGame/Content/FactoryGame/Recipes/Constructor/Recipe_Biomass_Wood
        recipe_registry
            .entry("Biomass")
            .or_insert_with(Vec::new)
            .push(biomass_recipe);
        let cable_recipe = Recipe {
            ...
            manufacturing_duration: 2f32,
            alternate: false,
        }; // FactoryGame/Content/FactoryGame/Recipes/Constructor/Recipe_Cable
        recipe_registry
            .entry("Cable")
            .or_insert_with(Vec::new)
            .push(cable_recipe);
        let concrete_recipe = Recipe {
            ...
            manufacturing_duration: 4f32,
            alternate: false,
        }; // FactoryGame/Content/FactoryGame/Recipes/Constructor/Recipe_Concrete
        recipe_registry
            .entry("Concrete")
            .or_insert_with(Vec::new)
        ...
        let iron_rod_recipe = Recipe {
            ...
            manufacturing_duration: 4f32,
            alternate: false,
        }; // FactoryGame/Content/FactoryGame/Recipes/Constructor/Recipe_IronRod
        recipe_registry
            .entry("Iron Rod")
            .or_insert_with(Vec::new)
        ...
        let screw_recipe = Recipe {
            ...
            manufacturing_duration: 6f32,
            alternate: false,
        }; // FactoryGame/Content/FactoryGame/Recipes/Constructor/Recipe_Screw
        recipe_registry
            .entry("Screw")
            .or_insert_with(Vec::new)
            .push(screw_recipe);
        let silica_recipe = Recipe {
            ...
            manufacturing_duration: 8f32,
            alternate: false,
        }; // FactoryGame/Content/FactoryGame/Recipes/Constructor/Recipe_Silica
        recipe_registry
            .entry("Silica")
            .or_insert_with(Vec::new)
            .push(silica_recipe);
        ...
        let wire_recipe = Recipe {
            ...
            manufacturing_duration: 4f32,
            alternate: false,
        }; // FactoryGame/Content/FactoryGame/Recipes/Constructor/Recipe_Wire
        recipe_registry
            .entry("Wire")
            .or_insert_with(Vec::new)
            .push(wire_recipe);
        ...
        let iron_rebar_recipe = Recipe {
            ...
            manufacturing_duration: 4f32,
            alternate: false,
        }; // FactoryGame/Content/FactoryGame/Recipes/Equipment/Recipe_SpikedRebar
        recipe_registry
            .entry("Iron Rebar")
            .or_insert_with(Vec::new)
        ...
        let snowball_recipe = Recipe {
            ...
            manufacturing_duration: 12f32,
            alternate: false,
        }; // FactoryGame/Content/FactoryGame/Recipes/Holiday/Recipe_Snowball
        recipe_registry
            .entry("Snowball")
            .or_insert_with(Vec::new)
        ...
        let fuel_recipe = Recipe {
            ...
            manufacturing_duration: 6f32,
            alternate: false,
        }; // FactoryGame/Content/FactoryGame/Recipes/OilRefinery/Recipe_ResidualFuel
        recipe_registry
            .entry("Fuel")
            .or_insert_with(Vec::new)
            .push(fuel_recipe);
        ...
        let iron_ingot_recipe = Recipe {
            ...
            manufacturing_duration: 2f32,
            alternate: false,
        }; // FactoryGame/Content/FactoryGame/Recipes/Smelter/Recipe_IngotIron
        recipe_registry
            .entry("Iron Ingot")
            .or_insert_with(Vec::new)
